...
export const useWebRTC = (socket, currentUserId, peerId) => {
  ...
  // -----------------------
  useEffect(() => {
    if (!socket || !currentUserId || !peerId || isInitialized.current) return;
    ...
    const setupSocketListeners = () => {
      ...
      // Return cleanup function for socket listeners
      return () => {
  ...
  // -----------------------
// In the getLocalStream function, add more detailed logging:
